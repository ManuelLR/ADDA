...
public class Stream2<T> implements Stream<T> {
	 ...
	 * @return Un stream con las l�neas del fichero
	 */
	...
	/**
	 * @param s Un String
	 * @param delim Un conjunto de delimitadores o un aexpresi�n regular en general
	...
	/**
	 * @pre this no es vac�a
	 * @return Un Stream con un s�lo elemento escogido al azar de entre los elementos
	 * del stream original
	 */
	...
	/**
	 * @param st Un stream
	 * @return La concatenaci�n de this con st
	 */
	 ...
	 * @return Un conjunto ordenado seg�n cmp que contiene los elementos de this
	 */
	...
	/**
	 * @param s2 Un stream
	 * @param f Una bifunci�n
	 * @param <U> El tipo de los elementos de s2
	 * @param <R> El tipo de los elementos del stream resultante
	 * @return Un stream formado por los valores  calculados por la bifunci�n a partir de los pares formados 
	...
	/**
	 * @param s2 Un stream
	 * @param f1 Una funci�n
	 * @param f2 Una funci�n
	 * @param fr Una bifunci�n
	 * @param <U> El tipo de los elementos de s2
	...
	/**
	 * @param f1 Una funci�n para calcular la clave
	 * @param <K1> El tipo de la claves
	 * @return Un grupo de nivel 1 formado seg�n las claves calculadas por f1
	 */
	...
	/**
	 * @param f1 Una funci�n para calcular las claves
	 ...
	 * @return Un grupo de nivel 1 con claves ordenadas seg�n cmp y los grupos con la misma clave agrupados seg�n cl
	 */
	 ...
	 * @return Un grupo de nivel 1 y los grupos con la misma clave agrupados seg�n cl
	 */
	...
	/**
	 * @param f1 Una funci�n para calcular la primera clave
	 * @param f2 Una funci�n para calcular la segunda clave
	 * @param <K1> El tipo de la primera clave
	 * @param <K2> El tipo de la segunda clave
	 * @return Un grupo de nivel 2 formado seg�n las claves calculadas por f1 y f2
	 */
	 ...
	 * @param <R> El tipo de los valores resultantes asociados a las claves
	 * @return Un grupo de nivel 2 con claves ordenadas seg�n cmp1 y cmp2 y los grupos con las mismas claves agrupados seg�n cl
	 */
	 ...
	 * @param <K2> El tipo de la claves
	 * @param <R> El tipo de los valores resultantes asociados a las claves
	 * @return Un grupo de nivel 2 y los grupos con las mismas claves agrupados seg�n cl
	 */
	public <K1, K2, R> Group2<K1,K2,R>  groupBy2(Function<? super T, ? extends K1> f1,
			Function<? super T, ? extends K2> f2,
			Collector<T,?,R> cl) {
	 ...
	 * @param f1 Una funci�n para calcular la primera clave
	 * @param f2 Una funci�n para calcular la segunda clave
	 * @param f3 Una funci�n para calcular la tercera clave
	 * @param <K1> El tipo de la primera clave
	 * @param <K2> El tipo de la segunda clave
	 * @param <K3> El tipo de la tercera clave
	 * @return Un grupo de nivel 3 formado seg�n las claves calculadas por f1, f2 y f3
	 */
	 ...
	 * @return Un grupo de nivel 3, con las claves ordenadas seg�n  cmp1, cmp2 y cmp3 respectivamente, 
	 * y formado seg�n las claves calculadas por f1, f2 y f3
	 */
	...
	/**
	 * @param f1 Una funci�n para calcular la clave
	 * @param f2 Una funci�n para calcular el valor
