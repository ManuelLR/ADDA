...
public class Math2 {
	 ...
	 * @param a L�mite inferior
	 * @param b L�mte Superior
	 * @return Un dounble aleatorio que  est� en el intervalo  a &lt; = r &lt; b
	 */
	 ...
	 * @return Si se foerma una lista ls con todos los par�metros el m�todo devuelve un entero 
	 ...
	 * @return Un lista de tama�o n con n�meros reales en el intervalo a &lt; = r &lt; b 
	 */
	 ...
	 * @return El n�mero de btis necesario para poder codificarlo en binario
	 */
	 ...
	 * @param num Un entero
	 * @return Devuelve un valor en el rango 0..num-1 con la expresi�n e*num/maxEscala
	 */
	 ...
	 * @param maxEscala Un entero 
	 * @param num Un entero
	 * @return Devuelve un valor en el rango 0..num con la expresi�n e*(num+1)/maxEscala
	 */
