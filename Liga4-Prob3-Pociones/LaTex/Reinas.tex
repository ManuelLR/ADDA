...
\begin{tabularx}{\textwidth}{|r|X|}
	...
	Propiedades Compartidas & \begin{enumerate}[{\textbf{\textperiodcentered}}]
		...
		\item ¿¿Necesaria?? List\textless Integer\textgreater  \textbf{multiplicidades}: Guarda todas las multiplicidades de las pociones
	\end{enumerate}
	\\
	\hline
	...
	\textbf{\textperiodcentered} as: alternativas seleccionadas en el paso
	...
	\hline
	Instanciación & ProbPociones(0, 0, 0) \\
	\hline
	Instanciación & ProbPociones(?¿, ?¿, ?¿) \\
	\hline
	Problema Generalizado & \[ ppg(p) =
	\begin{cases}
	(p[1], )       & \quad \text{si} n \text{ is even}\\
	()			& \quad \text{i \textgreater  d.length() or nAct \textgreater= 0}\\
	cA_{a\epsilon A_{co, i, d}}  (c(jejeje)) & \quad \text{ecoc}\\
	\end{cases}
	\] 
	co=cAcu; d=despensa;
	
	p=(i, nAct, costeAcumulado)
